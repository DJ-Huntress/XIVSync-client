...
public class PlayerPerformanceConfig : IMareConfiguration
{
	...
	public bool WarnOnPreferredPermissionsExceedingThresholds { get; set; }
	...
	public bool AutoPausePlayersWithPreferredPermissionsExceedingThresholds { get; set; }

	public int VRAMSizeAutoPauseThresholdMiB { get; set; } = 550;

	public int TrisAutoPauseThresholdThousands { get; set; } = 250;

	public List<string> UIDsToIgnore { get; set; } = new List<string>();
}
