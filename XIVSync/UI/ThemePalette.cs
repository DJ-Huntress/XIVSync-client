...
public sealed class ThemePalette
{
	...
	public Vector4 PanelBg { get; set; } = new Vector4(0.07f, 0.08f, 0.12f, 0.6f);

	[JsonConverter(typeof(Vector4JsonConverter))]
	public Vector4 PanelBorder { get; set; } = new Vector4(0.25f, 0.45f, 0.95f, 1f);

	[JsonConverter(typeof(Vector4JsonConverter))]
	public Vector4 HeaderBg { get; set; } = new Vector4(0.12f, 0.2f, 0.36f, 0.75f);
	...
	[JsonConverter(typeof(Vector4JsonConverter))]
	public Vector4 Btn { get; set; } = new Vector4(0.15f, 0.18f, 0.25f, 0.75f);

	[JsonConverter(typeof(Vector4JsonConverter))]
	public Vector4 BtnHovered { get; set; } = new Vector4(0.25f, 0.45f, 0.95f, 0.75f);

	[JsonConverter(typeof(Vector4JsonConverter))]
	public Vector4 BtnActive { get; set; } = new Vector4(0.2f, 0.35f, 0.75f, 0.75f);
	...
	[JsonConverter(typeof(Vector4JsonConverter))]
	public Vector4 TooltipBg { get; set; } = new Vector4(0.05f, 0.06f, 0.1f, 0.71f);
