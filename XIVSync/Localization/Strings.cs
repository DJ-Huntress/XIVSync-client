...
public static class Strings
{
	public class ToSStrings
	{
		...
		public readonly string Paragraph4 = Loc.Localize("Paragraph4", "The plugin creator tried their best to keep you secure. However, there is no guarantee for 100% security. Do not blindly pair your client with everyone.");
		...
		public readonly string Paragraph6 = Loc.Localize("Paragraph6", "This service is provided as-is. In case of abuse join the XIVSync Discord.");
